...
logFile = '../../Logs/Antikoerper/reminderJob.log'
...
if __name__ == "__main__":
    try:
        ...
        sql = "Select Voranmeldung.Vorname, Voranmeldung.Nachname, Voranmeldung.Mailadresse, Termine.Slot, Termine.Stunde, Voranmeldung.Tag, Voranmeldung.Token, Voranmeldung.id, Station.Ort, Station.Adresse, Termine.opt_station_adresse, Termine.opt_station from Voranmeldung JOIN Termine ON Termine.id=Voranmeldung.Termin_id JOIN Station ON Termine.id_station=Station.id where Voranmeldung.Tag Between '%s 00:00:00' and '%s 23:59:59' and Reminded = 0 and Voranmeldung.Token is not NULL;" % (requestedDate,requestedDate)
        ...
        for i in recipients:
            try:
                ...
                if send_mail_reminder(mail, date, vorname, nachname, appointment, url, location):
